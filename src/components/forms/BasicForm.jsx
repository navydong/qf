                                ...
                                <Form onSubmit={this.handleSubmit}>
                                    ...
                                    >
                                        {getFieldDecorator('confirm', {
                                            rules: [{
                                                required: true, whitespace: true, message: '请确认你的密码!',
                                            }, {
                                                validator: this.checkPassword,
                                            }],
                                        })(
                                            <Input type="password" onBlur={this.handleConfirmBlur} maxLength="255" />
                                            )}
                                    </FormItem>
                                    <FormItem
                                        {...formItemLayout}
                                    ...
                                    >
                                        {getFieldDecorator('nickname', {
                                            rules: [{ required: true, whitespace: true, message: '请输入昵称!', whitespace: true }],
                                        })(
                                            <Input maxLength="255" />
                                            )}
                                    </FormItem>
                                    ...
                                    >
                                        {getFieldDecorator('residence', {
                                            ...
                                            rules: [{ type: 'array', required: true, whitespace: true, message: '请选择你的常住地址!' }],
                                        })(
                                    ...
                                    >
                                        {getFieldDecorator('phone', {
                                            rules: [{ required: true, whitespace: true, message: '请输入你的电话号码!' }],
                                        })(
                                            <Input addonBefore={prefixSelector} maxLength="255" />
                                        ...
                                        <Row gutter={8}>
                                            <Col span={12}>
                                                {getFieldDecorator('captcha', {
                                                    rules: [{ required: true, whitespace: true, message: '请输入你获取的验证码!' }],
                                                })(
